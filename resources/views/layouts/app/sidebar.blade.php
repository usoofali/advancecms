        ...
        <flux:sidebar.nav>
            @canany(['dashboard.view'])
                <flux:sidebar.group :heading="__('Overview')" class="grid">
                    @can('dashboard.view')
                        <flux:sidebar.item icon="home" icon:class="text-sky-500 dark:text-sky-400" :href="route('dashboard')" :current="request()->routeIs('dashboard')"
                            wire:navigate>
                            {{ __('Dashboard') }}
                        </flux:sidebar.item>
                    @endcan
            ...
            @canany(['institutions.view', 'departments.view', 'programs.view', 'staff.view', 'id_cards.manage', 'grading_systems.view', 'academic_sessions.view', 'system.manage'])
                <flux:sidebar.group :heading="__('Administration')" class="grid" expandable expanded="false">
                    @can('institutions.view')
                        <flux:sidebar.item icon="building-office-2" icon:class="text-indigo-500 dark:text-indigo-400" :href="route('cms.institutions.index')"
                    ...
                    @can('departments.view')
                        <flux:sidebar.item icon="square-3-stack-3d" icon:class="text-purple-500 dark:text-purple-400" :href="route('cms.departments.index')"
                    ...
                    @can('programs.view')
                        <flux:sidebar.item icon="academic-cap" icon:class="text-emerald-500 dark:text-emerald-400" :href="route('cms.programs.index')"
                    ...
                    @can('staff.view')
                        <flux:sidebar.item icon="user-group" icon:class="text-teal-500 dark:text-teal-400" :href="route('cms.staff.index')"
                    ...
                    @can('id_cards.manage')
                        <flux:sidebar.item icon="identification" icon:class="text-cyan-500 dark:text-cyan-400" :href="route('cms.id-cards.manage')"
                            :current="request()->routeIs('cms.id-cards.manage')" wire:navigate>
                            {{ __('ID Card Management') }}
                        </flux:sidebar.item>
                        <flux:sidebar.item icon="swatch" icon:class="text-fuchsia-500 dark:text-fuchsia-400" :href="route('cms.id-cards.templates')"
                            :current="request()->routeIs('cms.id-cards.templates')" wire:navigate>
                            {{ __('ID Card Templates') }}
                        </flux:sidebar.item>
                    @endcan

                    @can('academic_sessions.view')
                        <flux:sidebar.item icon="calendar-date-range" icon:class="text-amber-500 dark:text-amber-400" :href="route('cms.sessions.index')"
                    ...
                    @can('grading_systems.view')
                        <flux:sidebar.item icon="chart-bar" icon:class="text-violet-500 dark:text-violet-400" :href="route('cms.grading-systems.index')"
                            :current="request()->routeIs('cms.grading-systems.*')" wire:navigate>
                            {{ __('Grading Systems') }}
                        </flux:sidebar.item>
                    @endcan

                    @can('system.manage')
                        <flux:sidebar.item icon="globe-alt" icon:class="text-rose-500 dark:text-rose-400" :href="route('settings.website')"
                            :current="request()->routeIs('settings.website')" wire:navigate>
                            {{ __('Website Settings') }}
                        </flux:sidebar.item>
                    @endcan
            ...
            @canany(['applications.view', 'application_forms.view', 'applications.notify', 'students.create'])
                <flux:sidebar.group :heading="__('Admissions')" class="grid" expandable expanded="false">
                    @can('students.create')
                        <flux:sidebar.item icon="user-plus" icon:class="text-blue-500 dark:text-blue-400" :href="route('cms.students.create')"
                    ...
                    @can('applications.view')
                        <flux:sidebar.item icon="document-magnifying-glass" icon:class="text-amber-500 dark:text-amber-400" :href="route('cms.admissions.index')"
                    ...
                    @can('applications.notify')
                        <flux:sidebar.item icon="document-text" icon:class="text-orange-500 dark:text-orange-400" :href="route('cms.admissions.issue-notification')"
                    ...
                    @can('application_forms.view')
                        <flux:sidebar.item icon="document-plus" icon:class="text-emerald-500 dark:text-emerald-400" :href="route('cms.admissions.forms.index')"
            ...
            @canany(['students.view_dept', 'registrations.view', 'registration_status.update', 'registrations.view_personal', 'courses.view', 'courses.view_dept', 'courses.view_assigned', 'attendance.take', 'id_cards.request'])
                <flux:sidebar.group :heading="__('Academics')" class="grid" expandable expanded="false">
                    @can('students.view_dept')
                        ...
                        <flux:sidebar.item icon="academic-cap" icon:class="text-violet-500 dark:text-violet-400" :href="route('cms.alumni.index')"
                    ...
                    @can('registrations.view')
                        <flux:sidebar.item icon="clipboard-document-check" icon:class="text-emerald-500 dark:text-emerald-400" :href="route('cms.students.registration')"
                    ...
                    @can('registration_status.update')
                        <flux:sidebar.item icon="lock-closed" icon:class="text-rose-500 dark:text-rose-400" :href="route('cms.students.manage-registrations')"
                    ...
                    @can('registrations.view_personal')
                        <flux:sidebar.item icon="clipboard-document-check" icon:class="text-teal-500 dark:text-teal-400" :href="route('cms.students.portal-registration')"
                    ...
                    @can('registrations.print_form')
                        <flux:sidebar.item icon="document-text" icon:class="text-sky-500 dark:text-sky-400" :href="route('cms.students.course-form')"
                    ...
                    @can('registrations.print_exam_card')
                        <flux:sidebar.item icon="identification" icon:class="text-purple-500 dark:text-purple-400" :href="route('cms.students.exam-card')"
                    ...
                    @can('students.view_lecturers')
                        <flux:sidebar.item icon="user-circle" icon:class="text-pink-500 dark:text-pink-400" :href="route('cms.students.my-lecturers')"
                    ...
                    @can('id_cards.request')
                        <flux:sidebar.item icon="identification" icon:class="text-lime-500 dark:text-lime-400" :href="route('cms.id-cards.request')"
            ...
            @if(auth()->user()->institution?->hasAddon('exam_module'))
                @canany(['cbt_exams.view', 'cbt_questions.view', 'cbt_sync.view', 'cbt_results.view'])
                    <flux:sidebar.group :heading="__('CBT Exams')" class="grid" expandable expanded="false">
                        @can('cbt_exams.view')
                            <flux:sidebar.item icon="clipboard-document-list" icon:class="text-rose-500 dark:text-rose-400" :href="route('cms.cbt.exams')"
                                :current="request()->routeIs('cms.cbt.exams*')" wire:navigate>
                                {{ __('Manage Exams') }}
                            </flux:sidebar.item>
                            <flux:sidebar.item icon="key" icon:class="text-amber-500 dark:text-amber-400" :href="route('cms.cbt.pin-access')"
                        ...
                        @can('cbt_questions.view')
                            <flux:sidebar.item icon="question-mark-circle" icon:class="text-sky-500 dark:text-sky-400" :href="route('cms.cbt.questions')"
                                :current="request()->routeIs('cms.cbt.questions*')" wire:navigate>
                                {{ __('Question Bank') }}
                            </flux:sidebar.item>
                        @endcan

                        @can('cbt_sync.view')
                            <flux:sidebar.item icon="arrows-right-left" icon:class="text-indigo-500 dark:text-indigo-400" :href="route('cms.cbt.sync')"
                                :current="request()->routeIs('cms.cbt.sync*')" wire:navigate>
                                {{ __('Sync Hub') }}
                            </flux:sidebar.item>
                        @endcan

                        @can('cbt_results.view')
                            <flux:sidebar.item icon="check-badge" icon:class="text-emerald-500 dark:text-emerald-400" :href="route('cms.cbt.results')"
                                :current="request()->routeIs('cms.cbt.results*')" wire:navigate>
                                {{ __('Review Results') }}
                            </flux:sidebar.item>
                        @endcan
                    </flux:sidebar.group>
            ...
            @canany(['results.enter', 'results.view_dept', 'reports.generate', 'results.view_personal'])
                <flux:sidebar.group :heading="__('Results')" class="grid" expandable expanded="false">
                    @can('results.enter')
                        <flux:sidebar.item icon="pencil-square" icon:class="text-emerald-500 dark:text-emerald-400" :href="route('cms.results.entry')"
                    ...
                    @can('results.view_dept')
                        <flux:sidebar.item icon="chart-bar" icon:class="text-blue-500 dark:text-blue-400" :href="route('cms.results.index')"
                    ...
                    @can('reports.generate')
                        <flux:sidebar.item icon="academic-cap" icon:class="text-purple-500 dark:text-purple-400" :href="route('cms.results.transcripts')"
                    ...
                    @can('results.view_personal')
                        <flux:sidebar.item icon="identification" icon:class="text-amber-500 dark:text-amber-400" :href="route('cms.results.portal')"
            ...
            @canany(['attendance.take', 'attendance.manage', 'attendance.view_history', 'attendance.view_own'])
                <flux:sidebar.group :heading="__('Attendance')" class="grid" expandable expanded="false">
                    @can('attendance.take')
                        <flux:sidebar.item icon="check-badge" icon:class="text-blue-500 dark:text-blue-400" :href="route('cms.attendance.take')"
                    ...
                    @can('attendance.manage')
                        <flux:sidebar.item icon="calendar-days" icon:class="text-indigo-500 dark:text-indigo-400" :href="route('cms.attendance.manage')"
                    ...
                    @can('attendance.view_history')
                        <flux:sidebar.item icon="clock" icon:class="text-amber-500 dark:text-amber-400" :href="route('cms.attendance.history')"
                    ...
                    @can('attendance.view_own')
                        <flux:sidebar.item icon="chart-bar" icon:class="text-rose-500 dark:text-rose-400" :href="route('cms.attendance.participation')"
    ...
    <flux:header class="lg:hidden print:hidden">
        ...
        <flux:dropdown position="top" align="end">
            ...
            <flux:menu>
                ...
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('profile.edit')" icon="cog" icon:class="text-indigo-500 dark:text-indigo-400" wire:navigate>
                        {{ __('Settings') }}
                    </flux:menu.item>
                </flux:menu.radio.group>
                ...
                <form method="POST" action="{{ route('logout') }}" class="w-full">
                    @csrf
                    <flux:menu.item as="button" type="submit" icon="arrow-right-start-on-rectangle" icon:class="text-rose-500 dark:text-rose-400"
