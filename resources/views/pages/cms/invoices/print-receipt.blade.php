        ...
        <div class="grid grid-cols-1 gap-1 mb-4">
            <div class="space-y-1">
                <div class="flex border-b border-zinc-100 pb-1">
                    ...
                    <span class="flex-1 uppercase font-bold text-base">{{ $receipt->payment?->studentInvoice?->student?->full_name }}</span>
                </div>
                <div class="flex border-b border-zinc-100 pb-1">
                    <span class="w-36 text-zinc-500 uppercase text-[10px] font-bold tracking-tight">Matric Number:</span>
                    <span class="flex-1 uppercase font-mono font-bold text-sm">{{ $receipt->payment?->studentInvoice?->student?->matric_number }}</span>
                </div>
                <div class="flex border-b border-zinc-100 pb-1">
                    <span class="w-36 text-zinc-500 uppercase text-[10px] font-bold tracking-tight">Program:</span>
                    <span class="flex-1 uppercase font-semibold text-sm">{{ $receipt->payment?->studentInvoice?->student?->program?->name }}</span>
                </div>
                <div class="flex border-b border-zinc-100 pb-1">
                    <span class="w-36 text-zinc-500 uppercase text-[10px] font-bold tracking-tight">Level:</span>
                    <span class="flex-1 uppercase font-bold text-sm">{{ $receipt->payment?->studentInvoice?->student?->currentLevel($receipt->payment?->studentInvoice?->invoice?->academicSession) }} LEVEL</span>
                </div>
                <div class="flex border-b border-zinc-100 pb-1">
                    <span class="w-36 text-zinc-500 uppercase text-[10px] font-bold tracking-tight">Payment For:</span>
                    <span class="flex-1 uppercase font-semibold text-zinc-800 text-sm">{{ $receipt->payment?->studentInvoice?->invoice?->title }}</span>
                </div>
                <div class="flex border-b border-zinc-100 pb-1">
                ...
                <div class="flex border-b border-zinc-100 pb-1">
                    ...
                    <span class="flex-1 uppercase font-semibold text-zinc-700 text-xs">{{ str_replace('_', ' ', ucfirst($receipt->payment?->payment_method)) }} (Manual)</span>
                </div>
                <div class="flex border-b border-zinc-100 pb-1">
